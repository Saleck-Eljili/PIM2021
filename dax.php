        ...
        <article>
          <header class="section background-white">
            <div class="line text-center">        
              <h1 class="text-dark text-s-size-30 text-m-size-40 text-l-size-headline text-thin text-line-height-1">Site de dax</h1>
          ...
          <div class="background-white full-width"> 
              ...
              <a class="image-with-hover-overlay image-hover-zoom" href="" title="Portfolio Image">
                <div class="image-hover-overlay background-primary"> 
                  <div class="image-hover-overlay-content text-center padding-2x">
                    <h3 class="text-white text-size-20 margin-bottom-10">Le grand requin</h3>
                    <p class="text-white text-size-14 margin-bottom-20">Dans l’intervalle de 15 années, on a constaté une diminution de près de 80 % de la population des requins. Le WWF (World Wildlife Fund) annonce que chaque année, plus de 100 millions de requins de différentes espèces sont tués.</p>  
                  </div> 
                </div> 
            ...
            <div class="s-12 m-6 l-five">
              <a class="image-with-hover-overlay image-hover-zoom" href="" title="Portfolio Image">
                <div class="image-hover-overlay background-primary"> 
                  <div class="image-hover-overlay-content text-center padding-2x">
                    <h3 class="text-white text-size-20 margin-bottom-10">Le lion de mer d’Australie</h3>
                    <p class="text-white text-size-14 margin-bottom-20">Le lion de mer d’Australie fait partie des Otariidae les plus rares qui existent sur notre planète, et qui sont aujourd’hui menacees. Avec un effectif estimé actuellement entre 12 000 et 13 000, le Neophaca cinerea est en danger d’extinction.</p>  
                  </div> 
                </div> 
